...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String url = "http://10.0.2.2:8000/login/?username=" + mEmail + "&password=" + mPassword;
            Log.d("url", url);
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            if (response.has("Error Code")) {
                                try {
                                    String error = response.getString("Description");
                                ...
                                try {
                                    ...
                                    Log.d("id, username, token", id + ", " + username + ", " + token);
                                }
                                catch (Exception e) {
                                    e.printStackTrace();
                                }
                                setSharedPrefs(token, id);
                                startActivity(new Intent(context, GroupSelectionActivity.class));
                                finish();
                            }
                        }
                    },
        ...
        private void setSharedPrefs(String token, Integer id) {
